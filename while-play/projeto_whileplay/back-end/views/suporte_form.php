...
<body>
    ...
    <form action="/while-play/projeto_whileplay/back-end/save-suporte" method="POST">
    ...
    <a class="back-link" href="/while-play/projeto_whileplay/back-end/list-suportes">← Voltar para Lista de Suporte</a>
