...
<form action="/while-play/projeto_whileplay/back-end/update-pagamento" method="POST">
...
<a href="/while-play/projeto_whileplay/back-end/list-pagamentos">Voltar para a lista de pagamentos</a>
