        ...
        <tr>
            ...
            <td>
                ...
                <?php if (!empty($item['arquivo_url']) && file_exists($arquivoPath)): ?>
                    <img src="/while-play/projeto_whileplay/back-end/<?= htmlspecialchars($item['arquivo_url']) ?>" alt="Imagem" />
                <?php else: ?>
                    Sem imagem
                <?php endif; ?>
            </td>
            ...
            <td>
                <a href="/while-play/projeto_whileplay/back-end/update-publicar/<?= $item['id'] ?>">Atualizar</a>
                <form action="/while-play/projeto_whileplay/back-end/delete-publicar" method="POST" style="display:inline;">
...
<a href="/while-play/projeto_whileplay/back-end/public/publicar">Nova Publicação</a>
