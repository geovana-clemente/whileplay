...
<body>
    ...
    <form action="whileplay/while-play/projeto_whileplay/back-end/update-roteiro" method="POST" enctype="multipart/form-data">
    ...
    <br>
    <a href="whileplay/while-play/projeto_whileplay/back-end/list-roteiros">Voltar para a lista de roteiros</a>
