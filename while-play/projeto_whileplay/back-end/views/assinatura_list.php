...
<body>
    ...
    <table border="1">
        ...
        <?php foreach ($assinaturas as $assinatura): ?>
            <tr>
                ...
                <td>
                    <a href="/while-play/projeto_whileplay/back-end/update-assinatura/<?= $assinatura['id'] ?>">Atualizar</a>

                    <form action="/while-play/projeto_whileplay/back-end/delete-assinatura" method="POST" style="display:inline;">
    ...
    <br>
   <a href="/while-play/projeto_whileplay/back-end/public/assinatura">Nova assinatura</a>
