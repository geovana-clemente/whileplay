...
<table>
    ...
    <?php if (!empty($roteiros)): ?>
        ...
        <tr>
            ...
            <td>
                <a href="/GitHub/whileplay/while-play/projeto_whileplay/back-end/update-roteiro/<?= $roteiro['id'] ?>">Atualizar</a>
...
<a href="/GitHub/whileplay/while-play/projeto_whileplay/back-end/public/roteiro">Novo roteiro</a>
