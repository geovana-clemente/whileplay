...
<body>
    ...
    <form action="/GitHub/whileplay/while-play/projeto_whileplay/back-end/update-perfil" method="POST" enctype="multipart/form-data">
        ...
        <?php if (!empty($perfilInfo['foto_url'])): ?>
            <img src="/GitHub/whileplay/while-play/projeto_whileplay/back-end/<?= htmlspecialchars($perfilInfo['foto_url']) ?>" alt="Foto do Perfil" class="current-photo">
        <?php else: ?>
