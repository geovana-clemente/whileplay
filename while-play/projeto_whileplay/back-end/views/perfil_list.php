        ...
        <tr>
            ...
            <td>
                ...
                <?php if (!empty($perfil['foto_url']) && file_exists($fotoPath)): ?>
                    <img src="/while-play/projeto_whileplay/back-end/<?= htmlspecialchars($perfil['foto_url']) ?>" alt="Foto de perfil" />
                <?php else: ?>
                    Sem foto
                <?php endif; ?>
            </td>
            ...
            <td>
                <a href="/while-play/projeto_whileplay/back-end/update-perfil/<?= $perfil['id'] ?>">Atualizar</a>
                <form action="/while-play/projeto_whileplay/back-end/delete-perfil" method="POST" style="display:inline;">
...
<a href="/while-play/projeto_whileplay/back-end/public/perfil">Criar Novo Perfil</a>
