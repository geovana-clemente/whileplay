...
<body>
    ...
    <form action="/while-play/projeto_whileplay/back-end/save-pagamento" method="POST" autocomplete="off">
...
<a href="/while-play/projeto_whileplay/back-end/list-pagamentos"><h4>Ver todos os pagamentos</h4></a>
